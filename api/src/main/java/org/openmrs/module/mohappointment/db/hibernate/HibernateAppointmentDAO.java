...
public class HibernateAppointmentDAO implements AppointmentDAO {
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#cancelAppointment
    ...
    public List<Integer> getAppointmentIdsByMulti(Object[] conditions, int limit) {
        ...
        if (conditions != null) {// Returns combined conditions matching
            ...
            if (null != conditions[2] && !conditions[2].equals(""))
                combinedSearch.append(" location_id = " + conditions[2] + " AND ");
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#loadAllAppointments()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#getAppointmentStates
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @seeorg.openmrs.module.mohappointment.db.AppointmentDAO# getAppointmentStatesByName(java.lang.String)
     */
    @Override
    public AppointmentState getAppointmentStatesByName(String name) {
        ...
        return appState == null ? null : new AppointmentState((Integer) appState[0], (String) appState[1]);
    }
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#saveService(org.openmrs
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#saveServiceProviders
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#updateService(org
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#updateServiceProviders
     * (org.openmrs.module.mohappointment.service.IServiceProviders)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#getPersonsByService
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#getServiceByProvider
     * (org.openmrs.Person)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#getServiceById(java
     * .lang.Integer)
     */
    @Override
    ...
    /**
     * @see AppointmentDAO#getServiceByConcept(org.openmrs.Concept)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see AppointmentDAO#getServiceProviders()
     */
    @Override
    ...
    public Collection<Services> getServices() {
        ...
        List<Services> services = session.createCriteria(Services.class)
     ...
     * @see AppointmentDAO#getAllWaitingAppointmentsByPatient(org.openmrs.Patient,
     * AppointmentState,
     * java.util.Date)
     */
    @Override
    ...
    public List<Appointment> getAllAppointments(Date forDate) {
        ...
        if (forDate != null) {
            ...
            criteria.add(Restrictions.between("appointmentDate", forDate, maxDate));
        }
        return criteria.list();
    }
    ...
    public List<Appointment> getAppointmentsForService(Services service, Date startDate, Date endDate) {
        ...
        criteria.add(Restrictions.eq("voided", false));
        if (startDate != null) {
            criteria.add(Restrictions.ge("appointmentDate", startDate));
        }
        if (endDate != null) {
            criteria.add(Restrictions.le("appointmentDate", endDate));
        }
        return criteria.list();
    }
}
