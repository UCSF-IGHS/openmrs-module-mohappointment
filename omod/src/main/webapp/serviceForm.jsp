...
<h2><spring:message code="mohappointment.appointment.service.form"/></h2>
<br/>
...
<form action="service.form?save=true" method="post" class="box" id="formService">
	...
	<table>
		<tr>
			...
			<td valign="top"><input type="text" size="35" name="name" id="name" value="${service.name}"/></td>
		...
		<tr>
			...
			<td valign="top"><img border="0" src="<openmrs:contextPath/>/moduleResources/mohappointment/images/help.gif" title="?"/></td>
			<td valign="top"><textarea name="description" id="description" rows="3" cols="40">${service.description}</textarea></td>
